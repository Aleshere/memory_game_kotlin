...
import com.example.memory_game_kotlin.models.MemoryCard
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if(memoryCard.isFaceUp) {
                ...
                imageButton.setImageResource(if (memoryCard.isFaceUp) memoryCard.identifier else R.drawable.boston)
            }
